...
- **État des tests** : 781/781 verts (613 unitaires + 168 intégration) — et la
  ...
  **--coverage**, et TSan ciblé **BLOQUANT** en CI sur les suites concurrentes
  (`WsServer|Watchdog|BotState`). +49 au Sprint 18 (baseline recalée sur
  `ctest -N`=732 à l'ouverture, aucune dérive hors cycle : 30 unitaires +
  19 verrous OOS pour les deux nouvelles familles de réouverture). Détail au
  changelog.
